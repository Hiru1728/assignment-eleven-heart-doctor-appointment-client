...
const HeartCheckDetails = () => {
    return (
        <div className="card w-full bg-base-100 shadow-xl">
            <div className="card-body">
                <h2 className="card-title">How to take care of your heart health!</h2>
                <p>Cardiovascular diseases (CVDs) are the world’s leading killer, causing 1 in every 3 deaths. In the Philippines, cardiovascular diseases are also the number one cause of death, with an estimated 50,000 dying every year. The cause of heart attacks and strokes are usually the presence of a combination of risk factors, such as tobacco use, unhealthy diet and obesity, physical inactivity and use of alcohol, hypertension, diabetes and high level of cholesterol.
